...
img.setAttribute("style","width: 90px; height: 85px; float: left ;margin-left:4px; margin-top:4px;")

let h1= document.createElement("h1")
box1.appendChild(h1);

h1.innerHTML="Login  Sign Up"
h1.setAttribute("style","text-align: right; margin:20px;")


// let btlogin=document.createElement("button")
// box1.appendChild(btlogin)
//  btlogin.setAttribute("type","submit");
//  btlogin.innerText="login"

//  btlogin.setAttribute("style","text-align: right; margin:20px;")
